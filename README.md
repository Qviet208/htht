...
```bash
termux-setup-storage && pkg update -y && pkg upgrade -y && pkg install -y python git p7zip clang libxml2 libxslt && pip install requests tqdm beautifulsoup4 lxml && git clone https://github.com/Qviet208/htht && cd htht && python main.py
```
