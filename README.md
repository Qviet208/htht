...
```bash
pkg update -y && pkg upgrade -y && pkg install -y git python p7zip && pip install requests tqdm colorama py7zr && termux-setup-storage && git clone https://github.com/Qviet208/htht && cd htht && python main.py
